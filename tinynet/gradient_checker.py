...
def calculate_diff(grad_theta, grad_approx):
    """Calculate the distance between two vectors based on Frobenius norm."""
...
def check_gradients(model, X, Y, eps=1e-5):
    """Pass the data through the model and check whether the gradients were computed correctly.
